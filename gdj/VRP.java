...
public class VRP {
    ...
    public static void main(String[] args) {
        ...
        Solution s = new Solution(NoOfCustomers, NoOfVehicles, vehicleCapacity);
...
class Solution {
    ...
    Solution(int CustNum, int VechNum, int[] VechCap) {
        ...
        for (int i = 0; i < NoOfVehicles; i++) {
            Vehicles[i] = new Vehicle(i + 1, VechCap[i]);
            VehiclesForBestSolution[i] = new Vehicle(i + 1, VechCap[i]);
        }
    }
